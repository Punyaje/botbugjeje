...
// Base © �jejee°Hw Mods : Copyan Dari Base Dika

› Create By © °jeje°͢
› Base Ori © °jeje°͢
› Copyan Base Dika Hisoka Morou

🌷 KALAU MAU RENAME TARO CREDITS GUA : © °jeje°*/
...
//=================================================//
//=================================================//
case 'inibug': case 'jejejwangsaff': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case 'jejepunk': case 'jejewangsaff2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
{
"optionName": "SALAM BROTHER BY © °jejee°͢"
}
],
...
break
//=================================================//
case 'jejeetroli2': case 'jejeetrol': case 'jutrol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
"sellerJid": "6289647761210@s.whatsapp.net",
"token": "AR6z9PAvHjs9Qa7AYgBUjSEvcnOcRWycFpwieIhaMKdrhQ=="
}
}), { userJid: m.chat, quoted: doc })
haikal.relayMessage(m.chat, order.message, { messageId: order.key.id })
...
break
case 'jejetroli3': case 'jejetrol2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
for (let i = 0; i < jumlah; i++) {
 ...
 break
//=================================================//
case 'jejedocu': case 'jejedraknes':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'duc': case 'jejeslebew': case 'cumadocu': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'jejevirtext1': case 'jejezsu': case 'crashar1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case 'jejevirtext2': case 'jejetol': case 'crashar2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'jejevirtext3': case 'jejememek': case 'crashar3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'jejevirtext4': case 'jejecontol': case 'crashar4': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'jejevirtext5': case 'jejetextv': case 'crashar5': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'jejevirtext6': case 'jejegas': case 'crashar6':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'jejevirtext7': case 'jejevirtext': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case '🌷': case 'crashmek': case 'ampunsuhu': case 'ahyangbetul': case 'okemek': case 'jejenih': case 'crashar18': case 'mexdemam': case 'jeje1': case 'jento2': case 'jeje3': case 'jeje4': case 'jeje5': case 'jeje6': case 'jeje7': case 'jeje8': case 'jejen9': case 'jeje10': case 'jeje11': case 'jeje12': case 'jeje13': case 'jeje14': case 'jeje15': case 'jejen16': case 'jeje17': case 'jeje18': case 'jeje19': case 'jeje20': case 'jeje21': case 'jeje22': case 'jejen23': case 'jeje24': case 'jeje25': case 'jeje26': case 'jeje27': case 'jeje28':
case 'jeje29':
case 'jeje30':
case 'jeje31':
case 'jebot32':
...
case 'jeje59':
case 'jeje60':
case '🥶': case '🤑': case '️😝': case '🤪': case '😜': case '🤙': case '🏻': case '👌': case '😁': case '🖕': case '🤬': case '😡': case '💔': case '🔥': case '😭': case '🍂': case '🍃': case '🌴': case '🌿': case '🍀': case '🪵': case '🦥': case '🌳': case '🍁': case '🎋': 
case '🦂':
case '🐍':
case '🍓':
case '🍒': 
...
break
//=================================================//
case 'jejestik': case 'jejekangbug': case 'buttonkematian': case 'crashar19': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'jejebugie': case 'jejekangbug1': case 'crashar20': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'jejebutton': case 'jejekangbuttton': case 'testbutton': case 'inibutton': 
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
